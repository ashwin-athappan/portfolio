...
const COMPANY_NAMES = [
    ...
    "Procter & Gamble", "Walmart", "Target",
    "Costco", "Home Depot", "Lowe's", "Amazon Web Services", "Microsoft Azure", "Google Cloud", "Oracle Cloud Infrastructure",
    "IBM Cloud", "SAP Cloud", "Salesforce Cloud", "ServiceNow", "Workday", "Zoom", "Slack", "Atlassian",
    ...
    "Philips", "Lenovo", "HP (Hewlett-Packard)", "Dell", "Nvidia", "AMD", "Qualcomm",
    "Broadcom", "Texas Instruments", "Micron Technology", "Applied Materials", "Lam Research", "KLA Corporation", "ASML Holding",
    "Taiwan Semiconductor Manufacturing Company (TSMC)", "VMware", "Red Hat",
    "Mozilla Firefox", "Microsoft Edge", "Apple Safari", "Opera", "Brave", "Vivaldi",
    ...
    "Hughes Systique Corporation", "ISN Software", "HOC", "XBOX", "Other",
];
