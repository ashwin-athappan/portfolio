        ...
        >
            <div className="mb-4 flex">
                <div className="mr-4 shrink-0">
                    {isDataUrl(src) ? (
                        <img
                            ...
                            width={48}
                            height={48}
                            className="h-12 w-12 rounded-full border-2 border-gray-300 object-cover dark:border-dark-nav-border"
                        />
                    ) : (
                        <Image
                            src={src}
                ...
                <div className="min-w-0 flex-1 flex flex-col justify-center">
                    <p className={`m-0 truncate text-base font-semibold ${s.name}`}>
                        {testimonial.name}
                    </p>
                    <p className={`m-0 truncate text-sm opacity-70 ${s.designation}`}>
